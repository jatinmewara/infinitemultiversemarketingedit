    ...
    <body>
        ...
        <form method="POST" action="{{ route('register') }}">
            @csrf
             ...
             <!-- Name -->
            <x-text-input id="name" type="text" name="name" :value="old('name')" placeholder="Name" required autocomplete="username" />
            <x-input-error :messages="$errors->get('name')" class="mt-2" />

            <!-- Email Address -->
            <x-text-input id="email" type="email" name="email" :value="old('email')" placeholder="Email" required autocomplete="email" />
            <x-input-error :messages="$errors->get('email')" class="mt-2" />

            <!-- Password -->
            <x-text-input id="password" type="password" name="password" :value="old('password')" placeholder="Password" required autocomplete="password" />
            ...
            <!-- MCU Character -->
            <div class="mcu-character">
                <label for="favCharacter">Choose your favorite MCU character:</label>
                <select id="favCharacter" name="fav_character" required>
        ...
        <a href="/" class="login-link">Already have an account? Sign In</a>
    </div>
